...
- (void)viewDidAppear:(BOOL)animated {
    //[super viewDidAppear:animated]; これがないと画像向きがおかしくなるよ
}
...
- (void)viewDidLoad {
    ...
    [shotButton addTarget:self.delegate action:@selector(takePhoto:) forControlEvents:UIControlEventTouchUpInside];
    [cancelButton addTarget:self.delegate action:@selector(cancelCamera:) forControlEvents:UIControlEventTouchUpInside];
    
    [toolbar addSubview:shotButton];
    [toolbar addSubview:cancelButton];
    
    self.cameraOverlayView = toolbar;
}
...
- (IBAction)touchButton:(id)sender {
    _imagePicker = [[CameraViewController alloc] init];
